...
#        paytax.erie.gov website. for eg, the property with SBL# {} has the P_ID {} and you can access the tax information page here at
...
get_tax_exempt_status('242752') # yes, has exemptions
